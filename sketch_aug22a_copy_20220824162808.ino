...
void loop() {
  ...
  duration10 = pulseIn(echoPin10, HIGH);
  distance10 = duration10 * 0.034 / 2 - 1;
...
///calculate height 
  ...
  if(distance2 > 14){
    if(time != 0){
      ...
      Serial.print("Object was inserted for ");
      Serial.print( total);
  ...
  if(distance4 > 22 && distance9 > 22){
    if(time1 != 0){
      unsigned int total = millis() - time1;
      Serial.print("Object was inserted for ");
      Serial.print( total);
      Serial.println(" milliseconds");
      time1 = 0;
